...
// Copyright (c) 2017 The Cotton developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(794500, uint256("0x8bf9dc4fabb341e4b848c48bef9405c191c6ede18fe54717b6d0a74e19657f4d"))
	(798043, uint256("0x0a7e282980eb53b10719f42dec3364f84b09e1aa995fd3de97a1c61a5769399a"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1580664022, // * UNIX timestamp of last checkpoint block
    1637033,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 22123;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Cotton starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Cotton: 1.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // Cotton: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // Cotton: 60 Seconds
        nMaturity = 10;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 20000000  * COIN;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 802000;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Cotton new blockchain is here";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1531964826;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2113602;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Cotton: 1 day
        nTargetSpacing = 1 * 60;  // Cotton: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nNonce = 859482;

		 
	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ce4ff9b253cdf6661aa9f1c7f632736818c6d01fbd66b2af65cda44942a"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet cotton addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet cotton script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cotton BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cotton BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cotton BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Cotton: 1 day
        nTargetSpacing = 1 * 60;        // Cotton: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1515524400;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4283147;

        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51436;
        assert(hashGenesisBlock == uint256("0x000007332701f507ed4480754b73223160e1a5bf990210dcc0a9b77eea51fa1d"));
